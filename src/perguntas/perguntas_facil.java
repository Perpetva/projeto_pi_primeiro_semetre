...
public class perguntas_facil {
	public static String[][] getQuestoes() {
	    return new String[][] {
	        ...
	        {"Quem escreveu 'Romeu e Julieta'?", "a", "a) William Shakespeare", "b) Charles Dickens", "c) Jane Austen", "d) Fyodor Dostoevsky"},
	        
	        {"Qual é o maior oceano da Terra?", "d", "a) Oceano Atlântico", "b) Oceano Índico", "c) Oceano Ártico", "d) Oceano Pacífico"}
	    };
	}
}
